  ...
  final List<Map<String, dynamic>> _contents = [
    {
      ...
      "title": "Sewa Console Mudah",
      "desc": "Pilih PlayStation favoritmu, tentukan durasi, dan mainkan sepuasnya tanpa ribet."
    },
    {
      "icon": Icons.delivery_dining_rounded,
      "title": "Antar Jemput Unit",
      "desc": "Bisa main di tempat atau bawa pulang. Kami siap antar unit ke rumahmu dengan aman."
    },
    {
      "icon": Icons.verified_user_rounded,
      "title": "Aman & Terpercaya",
      "desc": "Unit terawat, stik original, dan transaksi transparan dengan sistem denda otomatis."
    },
  ];
            ...
            children: [
              ...
              Align(
                ...
                child: TextButton(
                  ...
                  child: const Text("LEWATI", style: TextStyle(color: Colors.white70, fontWeight: FontWeight.bold)),
                ),
              ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Icon(_contents[index]['icon'], size: 100, color: Colors.white),
                          ),
                    ...
                    Row(
                      ...
                      children: List.generate(_contents.length, (index) {
                        return AnimatedContainer(
                          ...
                          height: 8,
                          width: _currentIndex == index ? 25 : 8, // Titik aktif lebih panjang
                          decoration: BoxDecoration(
                            color: _currentIndex == index ? const Color(0xFF00C6FF) : Colors.grey.withOpacity(0.5),
